...
editorial_summary: >-
  Moses rejects the "homogeneous Black Belt" stereotype, arguing that
  Chicago's Black South Side contains sharply distinct areas of
  disorganization, transition, and organized community — and that
  delinquency maps onto this structure rather than onto race.
  Analyzing 1929 Juvenile Court records for 403 Black male delinquents
  by mile-zone and community type, he shows disorganized zones near
  the Loop produced delinquency rates six to seven times those of
  stable communities like West Woodlawn and Morgan Park.
