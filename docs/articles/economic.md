...
editorial_summary: >-
  Du Bois and Dill divide Black America into three economic strata—some
  300,000 independents, roughly 1.75 million struggling artisans and
  tenants, and over two million common laborers—and argue that race
  prejudice, union exclusion, and Southern peonage block the middle group's
  access to national industry. Drawing on the Thirteenth Census and the
  Calhoun School's cooperative land-buying experiment in Lowndes County,
  Alabama, they contend that justice, the ballot, and common schools are
  preconditions for Black economic development.
