...
editorial_summary: >-
  Williams maps the associational life of Chicago's rapidly growing Black
  population—roughly 50,000 in 1905, up forty percent in five years—and
  argues that residential segregation in the Black Belt has forced the
  community to build its own dense infrastructure of churches, secret
  orders, and clubs. She catalogs twenty-five churches, fourteen Odd
  Fellows and Masonic lodges, and new settlement ventures like the
  Frederick Douglass Center and Trinity Mission, while documenting the
  steady displacement of Black workers from barbering, waiting, and
  janitorial trades by Swedish and Greek immigrants.
