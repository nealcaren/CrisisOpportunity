...
editorial_summary: >-
  Work uses Eleventh Census prisoner counts, Chicago police-court records,
  and fieldwork in the South Side levee district and the West Side's
  seventeenth and eighteenth wards to show that Black arrest rates in
  Chicago far exceed both white rates in the city and Black rates in the
  South. He locates the cause not in racial disposition but in the
  concentration of recent migrants in slum districts abandoned by the
  Black church and untouched by settlement houses, and in the narrow band
  of menial occupations open to Black workers.
