...
editorial_summary: >-
  Frazier argues that rising Black juvenile delinquency in Chicago
  reflects neighborhood conditions rather than racial character:
  migrant families crowded into deteriorating zones near the Loop
  inherited delinquency rates that had been high for thirty years
  regardless of who lived there. Drawing on Juvenile Court data,
  Institute for Juvenile Research arrest records, and case documents,
  he traces a sharp gradient from over 40 percent delinquency in the
  innermost zone to under 2 percent in the stable, home-owning
  seventh zone.
