...
editorial_summary: >-
  Du Bois argues that the convict-lease system is the direct child of
  slavery, installed after Emancipation through vagrancy laws, hostile
  courts, and the auctioning of prisoners' labor to private lessees for
  state revenue. Drawing on New York State Library prison statistics
  showing the Southern states as the only region where prison income
  exceeded expense in 1890, together with Governor Atkinson's Georgia
  investigation and firsthand reports from camps such as Camp Hardmont,
  he traces the system's destruction of courts, free labor, and juvenile
  offenders alike.
...
new-found freedom, and too often with innocent victims of oppression.
...
actual outlay. This idea still dominates most of the Southern states.
