...
editorial_summary: >-
  Alexander argues that Black women's entry into manufacturing during
  and after World War I — nearly doubling their industrial workforce
  between 1910 and 1920 — reshaped both family income and the wider
  economy, helping make mass production possible. Drawing on census
  data and Women's Bureau surveys, she contends that factory work,
  despite low wages and marginal status, raised Black women's
  self-respect, broadened educational horizons, and offered a route
  to interracial working-class solidarity.
