...
editorial_summary: >-
  Reid indicts the American Federation of Labor for four decades of
  paper resolutions against racial exclusion while twenty-two national
  unions, eleven of them AFL affiliates, barred Black workers by
  constitution or ritual. Marshalling union constitutions, Federation
  convention records, and membership statistics showing Negro locals
  collapsing from 169 in 1919 to 21 in 1929, he argues the AFL's
  segregated "federal labor union" policy entrenched Jim Crow rather
  than dismantling it.
