...
editorial_summary: >-
  Writing as a newly installed college president rather than a
  detached scholar, Bond argues that Black elementary schools in
  the South must work within, but also push against, a caste-class
  structure of racial subordination and regional poverty that makes
  Mississippi apply tax rates thirteen times California's to fund
  comparable schooling. He draws on recent sociology — Dollard,
  Warner, Davis, Doyle, Frazier — to insist that the schoolmarm
  tradition of faith in the "improvability of mankind" remains
  indispensable even when social science counsels despair.
