...
editorial_summary: >-
  Writing from Atlanta in the wake of the Sam Hose lynching, Du Bois
  insists that the Black criminal class represents neither the mass of
  the race nor any inherent disposition, and identifies four social
  causes of Southern Black crime: the convict-lease system, a double
  standard of justice in the courts, the escalating barbarity of lynch
  mobs, and the rigid color line that severs communication between the
  best elements of both races. He marshals editorial clippings from the
  Atlanta Constitution to show white murderers walking free while Black
  children draw chain-gang sentences for petty theft.
