...
editorial_summary: >-
  Miller reviews the Chicago Commission on Race Relations' 1922 report on
  the 1919 riot, praising it as the first such study produced by a genuinely
  co-equal biracial commission and treating its findings as generalizable
  to Northern cities absorbing migrants. He highlights the volume's analysis
  of housing segregation, labor competition, and press incitement, while
  faulting its evasion of the school question and arguing that residential
  separation will prove both cause and partial cure of race friction.

pdf_URL: PDFS/Miller_1924_Negro_in_Chicago.pdf
