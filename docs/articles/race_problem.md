...
editorial_summary: >-
  Cooper argues that racial and cultural diversity, rather than threatening
  American civilization, is the very engine of its progress, drawing on a
  comparative reading of Asiatic, Greek, and European history by way of
  Guizot to show that societies governed by a single dominant principle
  stagnate while those marked by conflict advance. She rejects
  amalgamation, deportation, and colonization schemes and insists that the
  Black population is an indispensable element in America's equilibrium of
  contending forces.
...
Now I beg you to note that in none of these systems was a <span style="font-variant:small-caps;">Race
...
Thus, while everywhere else the predominance of one principle produced
